...
class Journey_Cluster_Model(models.Model):
    ...
    preprocessingModelFile = models.CharField(max_length=150, blank=True, null=True)
...
class Clustered_Journey_Graph(models.Model):
    ...
    clusterName   = models.CharField(max_length=50, blank=True, default="undefined", null=True)
...
class Clustered_Customer(models.Model):
    ...
    cluster          = models.ForeignKey(Clustered_Journey_Graph, null=True, on_delete=models.SET_NULL)